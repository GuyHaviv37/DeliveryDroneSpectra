...
** If created a controller for MustPickup-withoutFeatures spec - enter 'No Extra Features'
** Otherwise, only if commented out specific features from the spec. file - specify which features are indeed used.
